//Version 3
//CheckPoint 2
//We have achieved a  functional mp3 player
//The two things that need fixing are
//1) The delay on the joystick *FIXED
//2) The song ending and not going back *FIXED
//3) Cleaning the code to be more readable *FIXED half way
//3.1) Cleaning a lot of the not needed variables *DONE
//3,2) Possibly creating structs -MAYBE
#include "Timer.h"
